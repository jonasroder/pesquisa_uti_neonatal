...
import {serviceSave, serviceLoad} from "@/service/cadastros/via_administracao";
...
const handleBack = () => {
    router.push({name: 'ViaAdministracao-List'});
};

</script>

<template>
    <card-formulario title="Cadastro Via de Administração"
