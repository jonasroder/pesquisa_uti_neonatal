...
import {serviceList} from "@/service/cadastros/mecanismo_resistencia_microorganismo";
...
const navigateToEditPage = (id) => {
    router.push({
        name : 'MecanismoResistenciaMicroorganismo-Page',
        query: {id: id}
    });
};
</script>
...
<template>
    <CardListagem
        title="Mecanismo de Resistência"
