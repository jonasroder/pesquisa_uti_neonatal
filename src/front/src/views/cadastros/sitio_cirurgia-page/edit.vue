...
import {serviceSave, serviceLoad} from "@/service/cadastros/sitio_cirurgia";
...
const handleBack = () => {
    router.push({name: 'SitioCirurgia-List'});
};

</script>

<template>
    <card-formulario title="Cadastro Sítio Cirurgia"
