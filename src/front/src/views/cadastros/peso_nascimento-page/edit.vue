...
import {serviceSave, serviceLoad} from "@/service/cadastros/peso_nascimento";
...
const handleBack = () => {
    router.push({name: 'PesoNascimento-List'});
};

</script>

<template>
    <card-formulario title="Cadastro Classificação de Peso"
