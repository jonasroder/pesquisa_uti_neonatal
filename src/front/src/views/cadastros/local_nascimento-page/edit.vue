...
import {serviceSave, serviceLoad} from "@/service/cadastros/local_nascimento";
...
const handleBack = () => {
    router.push({name: 'LocalNascimento-List'});
};

</script>

<template>
    <card-formulario title="Cadastro Local do Nascimento"
