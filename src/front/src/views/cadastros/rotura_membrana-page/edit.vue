...
import {serviceSave, serviceLoad} from "@/service/cadastros/rotura_membrana";
...
const handleBack = () => {
    router.push({name: 'RoturaMembrana-List'});
};

</script>

<template>
    <card-formulario title="Cadastro Bolsa Rota"
