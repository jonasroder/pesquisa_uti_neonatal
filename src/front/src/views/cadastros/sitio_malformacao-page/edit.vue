...
import {serviceSave, serviceLoad} from "@/service/cadastros/sitio_malformacao";
...
const handleBack = () => {
    router.push({name: 'SitioMalformacao-List'});
};

</script>

<template>
    <card-formulario title="Cadastro Sítio Malformação"
