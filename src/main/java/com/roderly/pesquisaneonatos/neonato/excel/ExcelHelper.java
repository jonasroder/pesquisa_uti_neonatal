...
public class ExcelHelper {
    ...
    public static List<ExcelColumnMapping> createGrupoInfectadoColumnMapping() {
        ...
        for (int i = 0; i < NeonatoMapper.numeroAnalisesInfeccoes; i++) {
            ...
            columnMappings.add(new ExcelColumnMapping("DIAS CIRURGIA ATÉ " + (i + 1) + "ª INFECÇÃO", "ProcedimentosEpisodioInfeccao_" + i + "_diasCirurgiaAte"));
            columnMappings.add(new ExcelColumnMapping("DIAS CIRURGIA APÓS " + (i + 1) + "ª INFECÇÃO", "ProcedimentosEpisodioInfeccao_" + i + "_diasCirurgiaApos"));
    ...
    public static List<ExcelColumnMapping> createGrupoColonizadoColumnMapping() {
        ...
        for (int i = 0; i < NeonatoMapper.numeroAnalisesInfeccoes; i++) {
            columnMappings.add(new ExcelColumnMapping("DATA " + (i + 1) + "ª COLONIZAÇÃO", "ProcedimentosEpisodioInfeccao_" + i + "_data"));
            columnMappings.add(new ExcelColumnMapping("SÍTIO " + (i + 1) + "ª COLONIZAÇÃO", "ProcedimentosEpisodioInfeccao_" + i + "_sitio"));

            columnMappings.add(new ExcelColumnMapping("MICROORGANISMO " + (i + 1) + "ª COLONIZAÇÃO", "ProcedimentosEpisodioInfeccao_" + i + "_microorganismo"));
            columnMappings.add(new ExcelColumnMapping("CLASSIFICAÇÃO MICROORGANISMO " + (i + 1) + "ª COLONIZAÇÃO", "ProcedimentosEpisodioInfeccao_" + i + "_classificacaoMicroorganismo"));
            columnMappings.add(new ExcelColumnMapping("PERFIL RESISTÊNCIA MICROORGANISMO " + (i + 1) + "ª COLONIZAÇÃO", "ProcedimentosEpisodioInfeccao_" + i + "_perfilResistenciaMicroorganismo"));
            columnMappings.add(new ExcelColumnMapping("MECANISMO RESISTÊNCIA MICROORGANISMO " + (i + 1) + "ª COLONIZAÇÃO", "ProcedimentosEpisodioInfeccao_" + i + "_mecanismoResistenciaMicroorganismo"));

            columnMappings.add(new ExcelColumnMapping("COLONIZAÇÃO MISTA " + (i + 1) + "ª COLONIZAÇÃO", "ProcedimentosEpisodioInfeccao_" + i + "_infeccaoMista"));

            columnMappings.add(new ExcelColumnMapping("MICROORGANISMO 2 " + (i + 1) + "ª COLONIZAÇÃO", "ProcedimentosEpisodioInfeccao_" + i + "_microorganismo2"));
            columnMappings.add(new ExcelColumnMapping("CLASSIFICAÇÃO MICROORGANISMO 2 " + (i + 1) + "ª COLONIZAÇÃO", "ProcedimentosEpisodioInfeccao_" + i + "_classificacaoMicroorganismo2"));
            columnMappings.add(new ExcelColumnMapping("PERFIL RESISTÊNCIA MICROORGANISMO 2 " + (i + 1) + "ª COLONIZAÇÃO", "ProcedimentosEpisodioInfeccao_" + i + "_perfilResistenciaMicroorganismo2"));
            columnMappings.add(new ExcelColumnMapping("MECANISMO RESISTÊNCIA MICROORGANISMO 2 " + (i + 1) + "ª COLONIZAÇÃO", "ProcedimentosEpisodioInfeccao_" + i + "_mecanismoResistenciaMicroorganismo2"));

            columnMappings.add(new ExcelColumnMapping("DIAS CIRURGIA ATÉ " + (i + 1) + "ª INFECÇÃO", "ProcedimentosEpisodioInfeccao_" + i + "_diasCirurgiaAte"));
            columnMappings.add(new ExcelColumnMapping("DIAS CIRURGIA APÓS " + (i + 1) + "ª INFECÇÃO", "ProcedimentosEpisodioInfeccao_" + i + "_diasCirurgiaApos"));

            columnMappings.add(new ExcelColumnMapping("DIAS FLEBOTOMIA ATÉ " + (i + 1) + "ª COLONIZAÇÃO", "ProcedimentosEpisodioInfeccao_" + i + "_diasFlebotomiaAte"));
            columnMappings.add(new ExcelColumnMapping("DIAS FLEBOTOMIA APÓS " + (i + 1) + "ª COLONIZAÇÃO", "ProcedimentosEpisodioInfeccao_" + i + "_diasFlebotomiaApos"));

            columnMappings.add(new ExcelColumnMapping("DIAS CVU ATÉ " + (i + 1) + "ª COLONIZAÇÃO", "ProcedimentosEpisodioInfeccao_" + i + "_diasCvuAte"));
            columnMappings.add(new ExcelColumnMapping("DIAS CVU APÓS " + (i + 1) + "ª COLONIZAÇÃO", "ProcedimentosEpisodioInfeccao_" + i + "_diasCvuApos"));

            columnMappings.add(new ExcelColumnMapping("DIAS PICC ATÉ " + (i + 1) + "ª COLONIZAÇÃO", "ProcedimentosEpisodioInfeccao_" + i + "_diasPiccAte"));
            columnMappings.add(new ExcelColumnMapping("DIAS PICC APÓS " + (i + 1) + "ª COLONIZAÇÃO", "ProcedimentosEpisodioInfeccao_" + i + "_diasPiccApos"));

            columnMappings.add(new ExcelColumnMapping("DIAS ENTUBAÇÃO ATÉ " + (i + 1) + "ª COLONIZAÇÃO", "ProcedimentosEpisodioInfeccao_" + i + "_diasEntubacaoAte"));
            columnMappings.add(new ExcelColumnMapping("DIAS ENTUBAÇÃO APÓS " + (i + 1) + "ª COLONIZAÇÃO", "ProcedimentosEpisodioInfeccao_" + i + "_diasEntubacaoApos"));

            columnMappings.add(new ExcelColumnMapping("DIAS SONDA VESICAL ATÉ " + (i + 1) + "ª COLONIZAÇÃO", "ProcedimentosEpisodioInfeccao_" + i + "_diasSondaVesicalAte"));
            columnMappings.add(new ExcelColumnMapping("DIAS SONDA VESICAL APÓS " + (i + 1) + "ª COLONIZAÇÃO", "ProcedimentosEpisodioInfeccao_" + i + "_diasSondaVesicalApos"));

            columnMappings.add(new ExcelColumnMapping("DIAS NUTRIÇÃO PARENTERAL ATÉ " + (i + 1) + "ª COLONIZAÇÃO", "ProcedimentosEpisodioInfeccao_" + i + "_diasNutricaoParenteralAte"));
            columnMappings.add(new ExcelColumnMapping("DIAS NUTRIÇÃO PARENTERAL APÓS " + (i + 1) + "ª COLONIZAÇÃO", "ProcedimentosEpisodioInfeccao_" + i + "_diasNutricaoParenteralApos"));

            columnMappings.add(new ExcelColumnMapping("DIAS DRENO ATÉ " + (i + 1) + "ª COLONIZAÇÃO", "ProcedimentosEpisodioInfeccao_" + i + "_diasDrenoAte"));
            columnMappings.add(new ExcelColumnMapping("DIAS DRENO APÓS " + (i + 1) + "ª COLONIZAÇÃO", "ProcedimentosEpisodioInfeccao_" + i + "_diasDrenoApos"));

            columnMappings.add(new ExcelColumnMapping("DIAS INTRACATH ATÉ " + (i + 1) + "ª COLONIZAÇÃO", "ProcedimentosEpisodioInfeccao_" + i + "_diasIntracathAte"));
            columnMappings.add(new ExcelColumnMapping("DIAS INTRACATH APÓS " + (i + 1) + "ª COLONIZAÇÃO", "ProcedimentosEpisodioInfeccao_" + i + "_diasIntracathApos"));

            columnMappings.add(new ExcelColumnMapping("DIAS CVC DUPLO LUMEN ATÉ " + (i + 1) + "ª COLONIZAÇÃO", "ProcedimentosEpisodioInfeccao_" + i + "_diasCvcDuploLumenAte"));
            columnMappings.add(new ExcelColumnMapping("DIAS CVC DUPLO LUMEN APÓS " + (i + 1) + "ª COLONIZAÇÃO", "ProcedimentosEpisodioInfeccao_" + i + "_diasCvcDuploLumenApos"));
        }
    ...
    public static List<ExcelColumnMapping> createIsoladosColumnMapping() {
        ...
        columnMappings.add(new ExcelColumnMapping("EP. INFECÇÃO", "nInfeccao"));
        columnMappings.add(new ExcelColumnMapping("EP. COLONIZAÇÃO", "nColonizacao"));
