package com.roderly.pesquisaneonatos.cadastros_gerais.peso_nascimento.controller;

import com.roderly.pesquisaneonatos.cadastros_gerais.peso_nascimento.service.PesoNascimentoService;
...
@RestController
@RequestMapping("/api/peso_nascimento")
@RequiredArgsConstructor
public class PesoNascimentoController {

    private final PesoNascimentoService service;
