...
VALUES (0, 'Anóxia', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 1),
       ...
       (0, 'SDR/Síndrome de Desconforto Respiratório', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 1),
       (0, 'SMH/Síndrome da Membrana Hialina', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 1),
